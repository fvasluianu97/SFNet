...
def validate_model(model_net, val_dataloader, save_disk=False, out_dir=None):
    model_net.eval()
    ...
    with torch.no_grad():
        ...
        for i, batch in enumerate(val_dataloader):
            ...
            map_img = tensor_to_img(map.detach().squeeze(0))

            if save_disk:
                imsave("{}/{}_in.png".format(out_dir, i), inp_img)
                # imsave("{}/{}_map.png".format(out_dir, i), map_img, check_contrast=False)
