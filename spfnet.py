...
class SPFNet(nn.Module):
    def __init__(self, in_channels, device="cuda"):
        ...
        self.c1 = SPFBlockDown(in_size=in_channels, rgb_in_size=3,
                               out_size=32, dwt_size=1, dropout=0.15, default=True, device=device)
        self.c2 = SPFBlockDown(in_size=65, rgb_in_size=32, out_size=64, dwt_size=2, dropout=0.2, device=device)
        self.c3 = SPFBlockDown(in_size=130, rgb_in_size=64, out_size=128, dwt_size=4, dropout=0.25, device=device)
        self.c4 = SPFBlockDown(in_size=260, rgb_in_size=128, out_size=256, dwt_size=8, dropout=0.3, device=device)
        self.c5 = SPFBlockDown(in_size=520, rgb_in_size=256,  out_size=256, dwt_size=16, dropout=0.0, device=device)

        self.d5 = SPFBlockUp(in_size=528, dwt_size=16, rgb_size=256, out_size=256, dropout=0.0)
        self.d4 = SPFBlockUp(in_size=512, dwt_size=8, rgb_size=256, out_size=128, dropout=0.3)
        self.d3 = SPFBlockUp(in_size=256, dwt_size=4, rgb_size=128, out_size=64, dropout=0.25)
        self.d2 = SPFBlockUp(in_size=128, dwt_size=2, rgb_size=64, out_size=32, dropout=0.2)
        self.d1 = SPFBlockUp(in_size=64, dwt_size=1, rgb_size=32, out_size=in_channels, dropout=0.1)
